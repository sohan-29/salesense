...
const icon = {
  ...
  executive: 'M3 3v18h18M9 17V9m4 8V5m4 12v-5M13 3l4 4',
};

const navByRole = {
  customer: [
    { to: '/', label: 'Catalog', icon: icon.catalog },
    { to: '/cart', label: 'Cart', icon: icon.cart },
    { to: '/wishlist', label: 'Wishlist', icon: icon.wishlist },
  ...
  admin: [
    ...
    { to: '/executive', label: 'Executive', icon: icon.executive },
